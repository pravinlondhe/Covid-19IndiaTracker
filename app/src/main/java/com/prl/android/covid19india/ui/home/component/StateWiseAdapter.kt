...
class StateWiseAdapter(private var data: List<Statewise>?, val listener: (Statewise?) -> Unit): RecyclerView.Adapter<StateWiseAdapter.StateWiseViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = StateWiseViewHolder(
        LayoutInflater.from(parent.context)
            .inflate(R.layout.item_statewise, parent, false))
